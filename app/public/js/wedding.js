...
$(function () {
  ...
  var tween = new TimelineMax()
    .add(TweenMax.to($J, 0.1, { strokeDashoffset: 0, ease: Linear.easeNone })) // draw word for 0.9
    ...
    .add(TweenMax.to($D, 0.1, { strokeDashoffset: 0, ease: Linear.easeNone })) // draw word for 0.9
    .add(TweenMax.to($Y2, 0.2, { strokeDashoffset: 0, ease: Linear.easeNone })) // draw word for 0.9
    .add(TweenMax.to("path", 1, { stroke: "#33629c", ease: Linear.easeNone }), 0)			// change color during the whole thing
    .add(TweenMax.to("path", 1, { fill: "#FFFFFF", ease: Linear.easeNone }))			// change color during the whole thing
